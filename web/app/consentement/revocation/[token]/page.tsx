...
export default async function RevocationPage({ params }: { params: Promise<{ token: string }> }) {
      ...
      <div className="w-full max-w-md">
        ...
        <div className="rounded-lg border border-line bg-surface-panel p-6 sm:p-8">
          ...
          <p className="mt-3 font-prose text-sm text-ink-muted">
            En confirmant ci-dessous, vous retirez votre autorisation parentale pour le compte brio
            de votre enfant. Son compte sera suspendu immédiatement.
          </p>
          ...
          <div className="mt-5 rounded-md border border-line bg-surface-raised px-4 py-4">
            <p className="font-prose text-sm text-ink-muted">
              Le retrait de l&apos;autorisation ne supprime pas le compte ni le travail de votre
              enfant. Contactez l&apos;établissement pour réactiver le compte si vous le souhaitez.
            </p>
          </div>
